...
public class PlayerViewTest {
    ...
    public void testGivenPlayerViewWhenInteractThenPutTokenError() {
        try (MockedStatic<Console> console = mockStatic(Console.class)) {
            ...
            when(this.logic.areAllTokensOnBoard()).thenReturn(false);
            when(this.logic.getPutTokenError(any(Coordinate.class))).thenReturn(Error.NOT_EMPTY, Error.NULL);
            this.playerView.interact();
    ...
    public void testGivenPlayerViewWhenInteractThenMoveTokenNotOwnerError() {
        try (MockedStatic<Console> console = mockStatic(Console.class)) {
            ...
            when(this.logic.getOriginMoveTokenError(any(Coordinate.class))).thenReturn(Error.NOT_OWNER, Error.NULL);
            when(this.logic.getTargetMoveTokenError(any(Coordinate.class),any(Coordinate.class))).thenReturn(Error.NULL);
            this.playerView.interact();
    ...
    public void testGivenPlayerViewWhenInteractThenMoveTokenNotEmptyError() {
        try (MockedStatic<Console> console = mockStatic(Console.class)) {
            ...
            doReturn(true).when(this.logic).areAllTokensOnBoard();
            doReturn(PlayerViewTest.ORIGIN, PlayerViewTest.TARGET).when(this.playerView).getCoordinate(any());
            when(this.logic.getOriginMoveTokenError(any(Coordinate.class))).thenReturn(Error.NOT_EMPTY, Error.NULL);
            when(this.logic.getTargetMoveTokenError(any(Coordinate.class),any(Coordinate.class))).thenReturn(Error.NULL);
            this.playerView.interact();
            verify(this.console).writeln("The square is not empty");
        }
    ...
    public void testGivenPlayerViewWhenInteractThenMoveTokenSameCoordinatesError() {
        try (MockedStatic<Console> console = mockStatic(Console.class)) {
            ...
            doReturn(PlayerViewTest.ORIGIN, PlayerViewTest.TARGET).when(this.playerView).getCoordinate(any());
            when(this.logic.getOriginMoveTokenError(any(Coordinate.class))).thenReturn(Error.NULL);
            when(this.logic.getTargetMoveTokenError(any(Coordinate.class),any(Coordinate.class))).thenReturn(Error.SAME_COORDINATES, Error.NULL);
            this.playerView.interact();
