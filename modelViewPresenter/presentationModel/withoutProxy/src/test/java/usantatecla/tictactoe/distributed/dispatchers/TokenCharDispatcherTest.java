...
public class TokenCharDispatcherTest {
    ...
    public void testDispatch() {
        this.playController.getTokenChar(new Coordinate(1,1));
        verify(this.tcpip).send(this.tcpipArgumentCaptor.capture());
        assertThat(this.tcpipArgumentCaptor.getAllValues().get(0),is(FrameType.TOKEN_CHAR.name()));
    }
}
